...
def get_model_class(model: str) -> Type[AutoModelForCausalLM]:
    # Vendored text-only core: the multimodal dispatch was severed. MsMoE
    # targets Qwen2.5 / Qwen2MoE (causal text models), and
    # AutoModelForImageTextToText requires transformers>=4.46 while this
    # package supports >=4.40.
...
class Model:
    ...
    def __init__(self, settings: Settings):
        ...
        # Multimodal models have a processor we'll want to save. The vendored
        # core is text-only, so no processor is ever loaded.
        self.processor = None
